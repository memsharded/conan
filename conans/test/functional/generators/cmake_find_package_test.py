...
class CMakeFindPathGeneratorTest(unittest.TestCase):
    ...
    def cmake_find_package_interface_test(self):
        ...
        header_h = textwrap.dedent("""
            #include <iostream>
            void header(){std::cout<<"Hello header";}
            """)
        client.save({"conanfile.py": header,
                     "src/header.h": header_h})
        client.run("create . header/1.0@")
        ...
        cmake = textwrap.dedent("""
            ...
            target_link_libraries(myapp PRIVATE header::header)
            """)
        main = textwrap.dedent("""
            #include "header.h"
            int main(){header();}
            """)
        client.save({"conanfile.py": user,
                     "src/myapp.cpp": main,
                     "src/CMakeLists.txt": cmake})
        client.run("create . user/1.0@")
        self.assertIn("Conan: Using autogenerated Findheader.cmake", client.out)

...
class PackageRevisionModeTest(unittest.TestCase):
    ...
    def full_dependency_graph_test(self):
        ...
        self.assertIn("GenericSU/0.3.5: Package '2d950a3e4c53e41a8a8946cc4d0eb8f5ef13510a' created",
                      self.client.out)
        self.assertIn("ManagementModule/0.3.5: Package '2d950a3e4c53e41a8a8946cc4d0eb8f5ef13510a' created",
                      self.client.out)
        self.assertIn("PleniterGenericSuApp/0.1.8: Package '69dda8da2b232bcff8af1579b0f37b34ef7b1829' created",
                      self.client.out)
        self.assertIn("StationInterfaceModule/0.13.0: Package '69dda8da2b232bcff8af1579b0f37b34ef7b1829' create",
                      self.client.out)
